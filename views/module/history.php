...
<head>
    ...
    <script type="text/javascript">
        ...
        function inputs(){
            ...
            window.location.href="../web/index.php?r=module/find&inputss="+inputss;
        }
        function so(){
            it=$("#ppp").val();
            it=it+' ASC';
            window.location.href="../web/index.php?r=module/managesss&it="+it;
        }
        function soo(){
            it=$("#ppp").val();
            it=it+' DESC';
...
<div style="width: 100%;background-color: white;margin-top: 37px;border: solid 1px" >
    <div style="margin-left: 15px;margin-top: 10px;">
        模块名称：<input id="input1" type="text" class="box_news" style="width: 80px">
        公司名称：<input id="input2" type="text" class="box_news" style="width: 80px">
        开通时间：<input id="input3" type="text" class="box_news" style="width: 80px">
        到期时间：<input id="input4" type="text" class="box_news" style="width: 80px">
        订单号：<input id="input5" type="text" class="box_news" style="width: 80px">
        <input type="button" class="clear_box" onclick="inputs();" value="查找">
        <select id="ppp" style="width: 120px; margin-left: 20px;" class="box_news">
        ...
        <input type="button" class="clear_box" onclick="so();" value="顺序">
        <input type="button" class="clear_box" onclick="soo();" value="倒序">
    </div>
    <div class="box-body" >
        ...
        <table id="example2" class="table table-bordered table-hover" style="background-color: white" >
            ...
            <tbody>
            <?php foreach ($moduleOrders as $key => $value) : ?>
                ...
                <tr>
                    ...
                    <td><?php echo $value->duration;?>个月</td>
