...
<head>
    ...
    <script type="text/javascript">
        ...
        function inputs(){
            ...
            window.location.href="../web/index.php?r=module/find2&inputss="+inputss;
        }
        function so(){
            it=$("#ppp").val();
            it=it+' ASC';
            window.location.href="../web/index.php?r=module/manages2&it="+it;
        }
        function soo(){
            it=$("#ppp").val();
            it=it+' DESC';
...
<div>
    <ul class="navigation-bar navigation-bar-right">
        ...
        <li class="li" id="end"><a herf="index.php?r=module/history2" class="a">已到期</a></li>
    </ul>
    ...
    <div class="box-body" >
        <table id="example2" class="table table-bordered table-hover" style="background-color: white" >
            ...
            <?php foreach ($endOrders as $key => $value) : ?>
                <?php $objs = (object)$value; ?>
                <tr>
                    <td><?php echo $objs->title;?></td>
                    <td><?php echo $objs->corp;?></td>
                    <td>  <?php echo $objs->username;?></td>
                    <td><?php echo $objs->mobile;?></td>
                    <td><?php echo $objs->start_time;?></td>
                    <td><?php echo $objs->end_time;?></td>
                    <td><?php echo $objs->order_num;?></td>
                    <td><?php echo $objs->total_price;?></td>
                    <th>已到期</th>
